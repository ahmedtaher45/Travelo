...
namespace Travelo.Infrastracture.Migrations
{
    ...
    [Migration("20260210020417_AddProfileImageHashToUser")]
    partial class AddProfileImageHashToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Travelo.Domain.Models.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("ProfileImageHash")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Travelo.Domain.Models.Entities.GeneralBooking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Travelo.Domain.Models.Entities.GeneralBooking", b =>
                {
                    ...
                    b.HasOne("Travelo.Domain.Models.Entities.BookingPrice", "PriceDetails")
                        .WithMany()
                        .HasForeignKey("PriceDetailsId");
            ...
            modelBuilder.Entity("Travelo.Domain.Models.Entities.MenuItem", b =>
                {
                    b.HasOne("Travelo.Domain.Models.Entities.MenuCategory", "Category")
                        .WithMany("items")
